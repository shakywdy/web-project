 ...
 * @LastEditTime: 2023-11-10 16:38:42
...
if (isset($_SESSION['user_id'])) {
  ...
  while($row_first = mysqli_fetch_assoc($result1)){
  $rowid = $row_first['id'];
  $rowpg = $row_first['programe'];
    //if friends
  $sql_second = "SELECT name, id
    FROM students
    WHERE programe = '$userProgram' AND id = '$rowid' AND id 
    NOT IN 
    (
      SELECT friendid
      FROM friends
    ...
    <div class="left-top">
        <div class="left-top-right">
            ...
            <div class="search-box">     
              ...
              <button class="del-search" id="del-search" onclick="delsearch()">
                X
                </button>
              </div>
            </div>
